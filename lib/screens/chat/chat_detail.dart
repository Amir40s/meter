...
class ChatDetail extends StatelessWidget {
  final String userUID, name,image,otherEmail,chatRoomId,userStatus;
  ChatDetail({super.key, required this.userUID, required this.name, required this.image, required this.otherEmail, required this.chatRoomId, required this.userStatus});
            ...
            children: [
              ...
              Consumer<ChatProvider>(
               builder: (context, chatProvider, child){
                 log("message:: ${chatProvider.isUserBlock}");
                 return Expanded(
                   flex: 2,
                   child: chatProvider.isUserBlock == true ?
                   Row(
                     children: [
                   ...
                   TextWidget(title: "User Blocked",textColor: Colors.black,fontSize: 14.0,),
                 );
               },
              )
            ],
